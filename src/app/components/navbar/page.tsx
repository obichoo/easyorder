    ...
    return (
        <nav className="bg-gray-100 border-b border-gray-300 p-4 flex justify-between items-center">
            <div className="flex items-center">
                <img src="/logo.png" alt="Logo Easyorder" className="h-16 mr-3 rounded-full border-2 border-teal-500" />
            ...
            <ul className="flex space-x-8 text-lg">
                ...
                <li>
                    <Link href="/favoris" className="text-gray-700 hover:text-gray-900">Mes favoris</Link>
                </li>
                <li>
